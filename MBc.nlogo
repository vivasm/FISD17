breed [batraquios batraquio]
batraquios-own [velocidade]


to setup
  clear-all

  create-batraquios 100 [
    setxy random-xcor random-ycor
    set velocidade random-float 0.9
  ]
  reset-ticks
end
